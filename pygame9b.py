...
def foo():
    print("A function call in call back")
...
oButton2 = SimpleButton(window, (25, 30), 'images/buttonUp.png', 'images/buttonDown.png', foo)
oButton3 = SimpleButton(window, (275, 30), 'images/buttonUp.png', 'images/buttonDown.png')
